...
function clone(value, valueType) {
    switch (valueType) {
        ...
        case 'Buffer':
            return /*#__INLINE__*/ cloneBuffer(value);
...
function recursiveCopy(value, clone, references, visited, customizer) {
    ...
    const keys = /*#__INLINE__*/ getKeys(value, valueType);
    // walk within collection with iterator
    for (const collectionKey of keys) {
        const collectionValue = /*#__INLINE__*/ getValue(value, collectionKey, valueType);
        if (visited.has(collectionValue)) {
            // for [Circular]
            setValue(clone, collectionKey, references.get(collectionValue), valueType);
        }
        else {
            ...
            setValue(clone, collectionKey, recursiveCopy(collectionValue, copiedCollectionValue, references, visited), valueType);
        }
    }
