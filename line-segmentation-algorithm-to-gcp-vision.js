...
import * as coordinatesHelper from './coordinatesHelper.js';
 ...
 */
function initLineSegmentationInternal(data) {
...
export const initLineSegmentation = function (data) {
    return initLineSegmentationInternal(data);
};
